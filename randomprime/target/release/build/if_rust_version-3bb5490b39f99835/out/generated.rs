...
macro_rules! if_rust_version_impl {
    ...
    (>= 1.40 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.41 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.42 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.43 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.44 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.45 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.46 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.47 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.48 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.49 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= $n:tt { $($if_:tt)* } { $($else_:tt)* } ) => { $($else_)* };
    (== 1.49 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (== nightly { $($if_:tt)* } { $($else_:tt)* }) => { $($else_)* };
    (== $n:tt { $($if_:tt)* } { $($else_:tt)* }) => { $($else_)* };
    (> 1.49 { $($if_:tt)* } { $($else_:tt)* }) => { $($else_)* };
