...
export class UpdateService {
  ...
  checkForUpdates(): void {
    this.http.get('https://raw.githubusercontent.com/MeriKatt/metroid-prime-randomizer-custom/master/package.json')
      .subscribe((data: any) => {
        if (compareVersions(version, data.version) < 0) {
          ...
          }).onTap.pipe(take(1)).subscribe(() => this.electronService.shell.openExternal('https://github.com/MeriKatt/metroid-prime-randomizer-custom/releases/latest'))
        }
      });
  }
}
